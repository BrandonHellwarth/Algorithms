...
/**
    ...
    */
recursiveMax(runner = this.head, maxNode = this.head.data) {
    if(this.isEmpty()){
        return null;
    }
    if(runner.next == null){
    ...
    if(runner.next.data > maxNode){
        return this.recursiveMax(runner = runner.next, maxNode = runner.data)
    }
